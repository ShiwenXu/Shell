...
union YYSTYPE
{
#line 25 "shell.y" /* yacc.c:355  */

  char        *string_val;
  // Example of using a c++ type in yacc
  std::string *cpp_string;

#line 150 "y.tab.cc" /* yacc.c:355  */
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      84,    85,    89,   105,   113,   114,   118,   131,   136,   142,
     148,   155,   163,   164,   165,   169,   172
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "GREATGREAT", "GREATAMPERSAND", "GREATGREATAMPERSAND",
  "TWOGREAT", "PIPE", "AMPERSAND", "$accept", "goal", "commands",
  "command", "simple_command", "command_and_args", "argument_list",
  "argument", "command_word", "piple_list", "iomodifier_opt",
  "iomodifier_list", "background_option", YY_NULLPTR
};
#endif
...
{
      18,     0,    -6,    -6,     2,    17,    -6,    -6,    -6,    -6,
       4,    -6,    -6,    -6,     8,    19,    20,    23,    24,    25,
      26,    27,    -6,    -5,    -6,    -6,    -6,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    -6,    28,    -6
};
...
{
      15,    16,    12,    17,    18,    19,    20,    11,    33,    15,
      16,    24,    17,    18,    19,    20,    21,    -2,     1,     1,
       2,     2,    26,    27,     3,     3,    28,    29,    30,    31,
       2,    32,    34,     0,    13,    36
};

static const yytype_int8 yycheck[] =
{
       5,     6,     0,     8,     9,    10,    11,     7,    13,     5,
       6,     3,     8,     9,    10,    11,    12,     0,     1,     1,
       3,     3,     3,     3,     7,     7,     3,     3,     3,     3,
       3,    21,    23,    -1,     5,     7
};
...
{
       0,     1,     3,     7,    15,    16,    17,    18,    19,    22,
      23,     7,     0,    17,    20,     5,     6,     8,     9,    10,
      11,    12,    24,    25,     3,    21,     3,     3,     3,     3,
       3,     3,    19,    13,    24,    26,     7
};
...
#line 72 "shell.y" /* yacc.c:1646  */
    {Shell::prompt();}
#line 1288 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 8:
#line 73 "shell.y" /* yacc.c:1646  */
    { yyerrok; }
#line 1294 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1303 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 12:
#line 89 "shell.y" /* yacc.c:1646  */
    {
    //printf("   Yacc: insert argument \"%s\"\n", $1->c_str());
      if ((strchr((yyvsp[0].cpp_string)->c_str(),'?') && !strchr((yyvsp[0].cpp_string)->c_str(), '{')) || strchr((yyvsp[0].cpp_string)->c_str(),'*'))
      {
        char *add = (char*)malloc(sizeof(char) * 100);
        strcpy(add, (yyvsp[0].cpp_string)->c_str());
...
#line 1409 "y.tab.cc" /* yacc.c:1646  */
      default: break;
    }
